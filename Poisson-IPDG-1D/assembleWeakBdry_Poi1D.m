...
idx = 1:nDof;
B(idx,idx) = - beta * dphi' * phi - phi' * dphi + (sigma/h0) * (phi' * phi);
F(idx) = - beta * dphi * g0 + (sigma/h0) * phi * g0;
...
B(idx,idx) = - beta * dphi' * phi - phi' * dphi + (sigma/h1) * (phi' * phi);
F(idx) = - beta * dphi * g1 + (sigma/h1) * phi * g1;
